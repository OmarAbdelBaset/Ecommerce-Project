...
{
    $dID = $_GET['delete'];
    $delete = "DELETE FROM `departments` WHERE id= $dID";
...
<body style="background-color: #f5f4f4;">
    ...
    <table class=" table table-dark table-striped">
        ...
        <tr>
            ...
            <td>
               <a href="deplist.php?delete=<?php echo $data['ID'] ?>  " onclick="return confirm('are you sure?')" class="btn btn-danger"> Delete</a>
               <a href="adddep.php?edit=<?php echo $data['ID'] ?> " class="btn btn-primary"> Update</a>
